...
export const featureFlags = getTables().featureFlags
export const professions = getTables().professions
export const auditLogs = getTables().auditLogs
export const platformNotifications = getTables().platformNotifications
export const businessMeta = getTables().businessMeta
export const platformSettings = getTables().platformSettings
